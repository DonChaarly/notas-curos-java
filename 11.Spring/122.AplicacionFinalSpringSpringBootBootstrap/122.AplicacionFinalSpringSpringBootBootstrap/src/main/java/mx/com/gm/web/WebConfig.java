...
public class WebConfig implements WebMvcConfigurer{
    ...
    //120 Se hace el mapping del url del path por default
    @Override
    public void addViewControllers(ViewControllerRegistry registro){
        //120 Registramos unas de las vistas que vamos a utilizar en la aplicacion
        //120 Estas vistas no pasan por ningun controlador por ello se registran
