...
public class ControladorInicio {
    ...
    //120 Se puede obtener el usuario que ha hecho login desde el controlador de spring con la anotacion @AutenticationPrincipal y pasando como argumento User
    public String inicio(Model model, @AuthenticationPrincipal User user){
        ...
        //122 Se crea una variable SaldoTotal para guardar la informaicon
        var saldoTotal = 0D;
        for (var p: personas){
            saldoTotal += p.getSaldo();
        }
        model.addAttribute("saldoTotal", saldoTotal);;
        //122 Se comparte tambien la cantidad de personas
