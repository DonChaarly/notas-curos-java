...
public class ControladorInicio {
    ...
    //Inyectamos una instancia de la interface PersonaDao para poder utilizar sus metodos, la anotacion de Autowired nos facilita la inyeccion de esta interface
    @Autowired
