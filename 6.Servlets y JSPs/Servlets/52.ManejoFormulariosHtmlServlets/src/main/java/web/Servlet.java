...
public class Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        //Se recuperan todos los valores del formulario con la funcion getParameter y se introduce el nombre del parametro a recuperar
        String usuario = request.getParameter("usuario");
        String password = request.getParameter("password");
        //Para recuperar un arreglo se utiliza la funcion getParameterValues
        ...
        out.print("<td>");
        //Para varios elementos de un arreglo se ocupa un for
