...
//Esta clas puede utilizarse entre diferentes proyectos
public class Conexion {

    //Atibutos
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/test?useSSL=false&useTimezone=true&serverTimezone=UTC&allowPublicKeyRetrieval=true";//URL denuestra base de datos
