...
//                         IP:#puerto/nombre de base de datos/?(Diversos parametros de seguridad)puerto seguro&zona horaria&zona horaria a utilizar&parametro para poderse conectar a la base de datos
        try {
            ...
            var sql = "SELECT id_persona, nombre, apelido, email, telefono FROM persona";//Se crea una cadena uqe contendra la istruccion que se va a ejecutar en mysql, con codigp de mysql
            ...
            while(resultado.next()){//Debido a que resutado nos puede regresar mas de un registro lo te¿iteramos para obtener todos los registros, y elmetodo next nos dice si tenemos un elemento todavia por iterar
                ...
                System.out.print(" Apellido: " + resultado.getString("apelido"));
