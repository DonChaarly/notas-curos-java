...
public class Alumno implements Serializable{
    ...
    //Se agrego el parametro de cascade en la anotacion de ManyToOne seleccionado la opcion de CascadeType.ALL, lo que quiere decir que para todas las acciones se va a ejecutar la persistencia en cascada
